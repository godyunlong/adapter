package com.xiuone.adapter.diver
...
import com.xiuone.adapter.dp2px
import com.xiuone.adapter.getColor
...
open class DiverItemDecoration : ItemDecoration {
    ...
    constructor(context:Context,@ColorRes horizontalColor: Int, horizontalWidth: Float, @ColorRes verticalColor: Int
        ...
        horizontalPaint.color = getColor(context,horizontalColor)
        verticalPaint.color = getColor(context,verticalColor)
        this.horizontalWidth = dp2px(context,horizontalWidth)
        this.verticalHeight = dp2px(context,verticalHeight)
